...
import storage.validate.RoleValidator;
...
public class RoleController {
	...
	public String showRoleList(Model model, HttpSession session,
	...
	public String save(Model model, @ModelAttribute("modelForm") @Validated Role role, BindingResult result,
		...
		// RoleRole roleRole = (RoleRole) role.getRoleRoles().iterator().next();
