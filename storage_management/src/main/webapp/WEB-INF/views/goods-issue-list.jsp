	...
	<div class="">
		<div class="x_panel">
			<div class="x_title">
				...
				<a class="btn btn-app" href="<c:url value="/goods-issue/add"/>"><i
					class="fa fa-plus"></i>Add</a>
				<a class="btn btn-app" href="<c:url value="/goods-issue/export"/>"><i
...
<script type="text/javascript">
  function confirmDelete(id) {
    if (confirm("Do you want to delete this record?")) {
      var baseUrl = '<c:url value="/goods-issue/delete/" />';
