										...
										<c:otherwise>
											<form:input path="category.name" disabled="true" />
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
									                        <form:input type="text" cssClass="form-control col-md-7 col-xs-12" placeholder="Code..." path="code" disabled="${viewOnly}"/>
									                        <div class="has-error">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-12">
									                        <form:input type="text" cssClass="form-control col-md-7 col-xs-12" placeholder="Name..." path="name" disabled="${viewOnly}"/>
									                        <div class="has-error">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-12">
									                        <form:textarea cssClass="form-control col-md-7 col-xs-12" placeholder="Description..." path="description" disabled="${viewOnly}"/>
									                        <div class="has-error">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-12">
									                        ...
									                        <div class="has-error">
									                        <form:errors path="multipartFile" cssClass="help-block"></form:errors></div>
                                                    </div>
                                                </div></c:if>
