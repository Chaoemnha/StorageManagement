						...
						<form:form modelAttribute="modelForm"
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<form:input type="text"
										...
										placeholder="Code..." path="code" disabled="${viewOnly}" />
									<div class="has-error">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-12">
									<form:input type="text"
										cssClass="form-control col-md-7 col-xs-12"
										placeholder="Name..." path="name" disabled="${viewOnly}" />
									<div class="has-error">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-12">
									<form:textarea cssClass="form-control col-md-7 col-xs-12"
							...
							<c:if test="${viewOnly}">
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-12">
										<img src="<c:url value='${modelForm.imgUrl}'/>" width="100px" height="100px" />
									</div>
								</div>
							</c:if>
