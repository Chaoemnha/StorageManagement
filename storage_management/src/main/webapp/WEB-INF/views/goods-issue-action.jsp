                                        ...
                                        <div class="x_content">
                                            <br/>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-12">
									                        <form:input type="text" cssClass="form-control" placeholder="Code..." path="code" disabled="${viewOnly}"/>
									                        <div class="has-error">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label for="qty"
                                                               class="control-label col-md-3 col-sm-3 col-12">Quantity</label>
                                                        <div class="col-md-6 col-sm-6 col-12">
									                        <form:input type="text" cssClass="form-control" placeholder="Quantity..." path="qty" disabled="${viewOnly}"/>
									                        <div class="has-error">
									                        <form:errors path="qty" cssClass="help-block"></form:errors></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label for="price"
                                                               class="control-label col-md-3 col-sm-3 col-12">Price</label>
                                                        <div class="col-md-6 col-sm-6 col-12">
									                        <form:input type="text" cssClass="form-control" placeholder="Price..." path="price" disabled="${viewOnly}"/>
									                        <div class="has-error">
									                        <form:errors path="qty" cssClass="help-block"></form:errors></div>
                                                        </div>
                                                    </div>
